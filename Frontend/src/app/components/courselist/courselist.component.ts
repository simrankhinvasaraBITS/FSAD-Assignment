...
export class CourselistComponent implements OnInit  {
  ...
  courseListLangFilter : Observable<Course[]> | null | undefined;
...
{
  if(this.enrolledStatus.slice(0, 1).shift() === "enrolled" || this.enrolledStatus2 === "enrolled" || this.loggedUser === "admin@gmail.com")
...
gotoURL(url : string)
{
 ...
 filterResults(language: string) {

  console.log("SIM : Language " , language)
  this.courseListLangFilter = this.userService.getCourseListByLanguage(language);

  // this.lenOfFilteredList = this.courseListLangFilter.[0];
  console.log("SIM : " ,this.courseListLangFilter)
 }
