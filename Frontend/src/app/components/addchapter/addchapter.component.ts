...
export class AddchapterComponent implements OnInit {
  ...
  constructor(private _router : Router, private _service : ProfessorService, private userService: UserService) {}  
    
  ngOnInit() {

    this.coursenames = this.userService.getCourseListNames();
